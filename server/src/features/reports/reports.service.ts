...
export class ReportsService {
  ...
  async getSalesSummary(from?: string, to?: string) {
    ...
    const completedDeliveries =
      await this.reportsRepository.getCompletedDeliveries(
        fromDate,
        toDate,
      );
  ...
  async getSalesDetails(from?: string, to?: string) {
  let fromDate: Date | undefined;
  let toDate: Date | undefined;
  ...
  const completedDeliveries =
    await this.reportsRepository.getSalesDetails(
      fromDate,
      toDate,
    );
...
async getProductSales(from?: string, to?: string) {
  let fromDate: Date | undefined;
  let toDate: Date | undefined;
  ...
  const deliveryItems =
    await this.reportsRepository.getProductSales(
      fromDate,
      toDate,
    );
...
async getCustomerSales(from?: string, to?: string) {
  let fromDate: Date | undefined;
  let toDate: Date | undefined;
  ...
  const deliveries =
    await this.reportsRepository.getCustomerSales(
      fromDate,
      toDate,
    );
...
async getStockMovementReport(from?: string, to?: string) {
  let fromDate: Date | undefined;
  let toDate: Date | undefined;
  ...
  const movements =
    await this.reportsRepository.getStockMovementReport(
      fromDate,
      toDate,
    );
...
async getDeliveryReport(from?: string, to?: string) {
  ...
  const deliveries =
    await this.reportsRepository.getDeliveryReport(
      fromDate,
      toDate,
    );
